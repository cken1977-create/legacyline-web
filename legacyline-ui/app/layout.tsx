    ...
    <html lang="en">
      <body className="min-h-screen bg-[#070A12] text-white antialiased">
        <div className="pointer-events-none fixed inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-44 right-[-120px] h-[520px] w-[520px] rounded-full bg-indigo-500/20 blur-3xl" />
          <div className="absolute left-[-140px] top-1/3 h-[420px] w-[420px] rounded-full bg-fuchsia-500/10 blur-3xl" />
        </div>
